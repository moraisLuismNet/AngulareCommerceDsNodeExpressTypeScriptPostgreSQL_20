...
export class GroupsService {
  ...
  getGroups(): Observable<IGroup[]> {
    ...
    return this.http.get<any>(`${this.urlAPI}groups`, { headers }).pipe(
      catchError((error) => {
  ...
  addGroup(group: IGroup): Observable<IGroup> {
    ...
    return this.http
      .post<IGroup>(`${this.urlAPI}groups`, formData, {
        headers,
        observe: "response",
      })
      .pipe(
  ...
  updateGroup(group: IGroup): Observable<IGroup> {
    ...
    return new Observable<IGroup>((subscriber) => {
      this.http
        .put<IGroup>(`${this.urlAPI}groups/${group.IdGroup}`, formData, {
          headers: headers,
          observe: "response",
        })
        .subscribe({
